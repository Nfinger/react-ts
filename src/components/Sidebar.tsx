...
const Link = (link: ILink) => (
    <Route path={link.path} key={link.key}>
        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
            ...
            <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">{link.notification}</div>
        </li>
    </Route>
)
