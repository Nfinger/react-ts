...
const SidebarLink = (link: ILink) => (
    <Link href={link.path} key={uuidv4()}>
        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
            <div className="flex items-center">
                {link.icon}
                <span className="text-sm  ml-2">{link.text}</span>
            </div>
            {link.notification ? <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs">{link.notification}</div> : null}
        </li>
    </Link>
)
